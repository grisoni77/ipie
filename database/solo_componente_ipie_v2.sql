...
INSERT INTO `ipie_ipie_company` (`company_id`, `name`, `province_id`, `city_id`, `cap`, `address`, `ragione_sociale`, `piva`, `employees`, `year_foundation`, `tel`, `fax`, `email`, `web`, `logo`, `area_eccellenza_it`, `area_eccellenza_en`, `collaborazioni`, `published`, `user_id`, `created_on`, `created_by`, `modified_on`, `modified_by`) VALUES
...
INSERT INTO `ipie_ipie_draft` (`draft_id`, `name`, `province_id`, `city_id`, `cap`, `address`, `ragione_sociale`, `piva`, `employees`, `year_foundation`, `tel`, `fax`, `email`, `web`, `logo`, `area_eccellenza_it`, `area_eccellenza_en`, `collaborazioni`, `company_id`, `state`, `created_on`, `created_by`, `modified_on`, `modified_by`) VALUES
