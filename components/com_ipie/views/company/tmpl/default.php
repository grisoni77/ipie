...
<?php if (0 == JRequest::getInt('print')) : ?>
    <ul class="actions">
        <li class="print-icon">
            <a href="<?php echo $print; ?>" title="Stampa" onclick="window.open(this.href, 'win2', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');
                    return false;" rel="nofollow"><img src="/media/system/images/printButton.png" alt="Stampa"  /></a>
        </li>
        <li class="email-icon">
...
<div class="scheda">
    ...
    <div class="blocco">
        ...
        <p class="spazia">
            ...
            <img src="<?php echo JUri::root().'images/ipie/logo/thumb/'.$item->logo ?>" alt="Logo <?php echo $item->name ?>" class="logo" />
            <br />
